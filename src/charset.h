...
// OScharset 无用
int JY_DrawStr(int x, int y, const char *str, int color, int size, const char *fontname, int charset, int OScharset);
...
// w 最终显示尺寸，宽度
// h 最终显示尺寸，高度
int JY_GetDrawStrSize(const char* str, int size, const char* fontname, int charset, int OScharset, int *w, int *h);
